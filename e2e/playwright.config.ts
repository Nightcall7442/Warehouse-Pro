 ...
 * из самой страницы: вход по cookie, а fetch внутри страницы несёт её так же,
 * как запросы приложения. Отдельный клиент Playwright Secure-куку по http не
 * шлёт и получал бы 401 всегда.
