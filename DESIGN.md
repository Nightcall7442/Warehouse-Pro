...
|------|------|--------|------|-------------|-------|
| Display / H1 | DM Sans | 700 | 32px | 1.2 | Embossed effect via text-shadow |
| H2 | DM Sans | 600 | 24px | 1.3 | |
| H3 | DM Sans | 600 | 18px | 1.4 | |
| Body | DM Sans | 400 | 14px | 1.6 | |
| Body emphasis | DM Sans | 500 | 14px | 1.6 | |
| Caption / label | DM Sans | 500 | 12px | 1.4 | Uppercase, letter-spacing +0.5px |
