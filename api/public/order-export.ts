...
export interface ExportedOrder {
  ...
  /**
   * Обещанный срок доставки — тот, что агент назвал магазину вслух.
   *
   * Пусто, пока человек его не поставил, и это законное значение: «не
   * обещали» и «обещали на сегодня» — разные вещи. Пункт 17-G запрещает
   * подставлять сюда догадку, и мы не подставляем: ни дату доставки, ни
   * «создан плюс сколько-то дней». По этому полю другая сторона считает
   * срывы, и выдуманный срок стал бы выдуманным срывом.
   *
   * Значит, и вывод о просрочке (пункт 9) возможен только по заказам, где
   * срок действительно назвали; по остальным он «неизвестно», как и был.
   */
