...
export const CashService = {
  ...
  /**
   * Долг сотрудника не деньгами (недостача товара): Дт долг сотрудника /
   * Кт недостача товара — в кассовых остатках ничего не движется, но долг
   * виден там же, где недостачи по наличным, и уходит в удержание из
   * зарплаты той же дорогой. Вызывается внутри чужой транзакции.
   */
