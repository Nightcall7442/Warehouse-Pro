...
function reset() {
  ...
  data = {
    commissions: [
      { id: 1, tenantId: 1, userId: 10, commissionRate: "5.00", deliveryRate: "0.00", periodType: "monthly", periodStart: MONTH_START, periodEnd: MONTH_END, salesAmount: "0.00", commissionAmount: "0.00", status: "pending" },
      { id: 2, tenantId: 1, userId: 11, commissionRate: "4.00", deliveryRate: "0.00", periodType: "monthly", periodStart: MONTH_START, periodEnd: MONTH_END, salesAmount: "5000000.00", commissionAmount: "200000.00", status: "paid" },
    ],
    users: [
...
describe("commission: ставка чужому сотруднику", () => {
  ...
  it("list не отдаёт имя владельца чужого аккаунта по строке, записанной до правки", async () => {
    ...
    data.commissions.push({
      id: 3, tenantId: 1, userId: 90, commissionRate: "1.00", deliveryRate: "0.00", periodType: "monthly",
