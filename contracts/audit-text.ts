...
const KEY_LABEL: Record<string, Label> = {
  ...
  van: { ru: "Машина", uz: "Mashina" }, plate: { ru: "Госномер", uz: "Davlat raqami" }, signed: { ru: "Подпись", uz: "Imzo" }, shortage: { ru: "Недостача", uz: "Kamomad" }, paid: { ru: "Оплачено", uz: "To'langan" },
  tare: { ru: "Тара", uz: "Idish" }, deposit: { ru: "Залог", uz: "Garov" }, units: { ru: "Штук", uz: "Dona" }, perUnit: { ru: "На единицу", uz: "Birlikka" },
...
export const AUDIT_ACTION_LABEL: Record<string, Label> = {
  ...
  "van.enabled": { ru: "Ван-селлинг включён", uz: "Van-selling yoqildi" },
  "van.disabled": { ru: "Ван-селлинг выключен", uz: "Van-selling o'chirildi" },
  "van.created": { ru: "Машина заведена", uz: "Mashina qo'shildi" },
  "van.updated": { ru: "Машина изменена", uz: "Mashina o'zgartirildi" },
  "van.loaded": { ru: "Машина загружена", uz: "Mashina yuklandi" },
  "van.unloaded": { ru: "Товар возвращён с машины", uz: "Tovar mashinadan qaytarildi" },
  "van.counted": { ru: "Машина пересчитана", uz: "Mashina sanaldi" },
  "van.sale": { ru: "Продажа с машины", uz: "Mashinadan sotuv" },
  "tare.enabled": { ru: "Учёт тары включён", uz: "Idish hisobi yoqildi" },
  "tare.disabled": { ru: "Учёт тары выключен", uz: "Idish hisobi o'chirildi" },
  "tare.type_created": { ru: "Вид тары заведён", uz: "Idish turi qo'shildi" },
  "tare.type_updated": { ru: "Вид тары изменён", uz: "Idish turi o'zgartirildi" },
  "tare.product_set": { ru: "Тара товара задана", uz: "Tovar idishi belgilandi" },
  "tare.returned": { ru: "Тара принята от магазина", uz: "Idish do'kondan qabul qilindi" },
  "tare.charged": { ru: "Тара списана в долг магазина", uz: "Idish do'kon qarziga yozildi" },
