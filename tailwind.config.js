  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        /*
          Кадры заканчиваются на "none", а не на "translateY(0)", и ни одна
          анимация не заливает результат (forwards).

          Заливка держит transform до конца жизни элемента, а любой
          transform, кроме none, делает элемент точкой отсчёта для
          position: fixed внутри себя.
      ...
      animation: {
        ...
        */
        ...
        // Без forwards по той же причине, что и у fade-up выше: заливка
        // держит transform и ломает position: fixed внутри.
