...
/*
  ...
  Кнопка фото — на любой открытой карточке, без проверки закрепления: ручка
  пишет в тот же круг магазинов, что отдаёт getShopById (вся организация).
  Раньше она писала только в закреплённые и молча теряла остальные снимки.
*/
