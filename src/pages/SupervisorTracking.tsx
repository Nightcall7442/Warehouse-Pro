  ...
  useEffect(() => {
    ...
    window.ymaps.ready(() => {
      ...
      locations.forEach((loc: any) => {
        ...
        const color = online ? "#22c47a" : "#9399a8";
        ...
        {[
          ...
          return (
            <div key={k.labelRu} className="kpi-card py-3 hover-lift animate-fade-in-up" style={{ animationDelay: `${idx * 60}ms` }}>
              ...
              <p className="font-label text-[10px] tracking-wider mt-1" style={{ color: "var(--color-text-tertiary)" }}>
                    ...
                    >
                      <div className="flex items-center gap-2.5">
                        <div className="w-9 h-9 rounded-full flex items-center justify-center flex-shrink-0 text-white text-xs font-bold"
                          style={{ background: online ? "var(--color-success)" : "var(--color-text-tertiary)" }}>
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-1 mt-0.5">
                            ...
                            {loc.accuracy && (
                              <span className="ml-auto text-[10px] font-data" style={{ color: "var(--color-text-tertiary)" }}>
                      ...
                      {(Number(loc.lat) && Number(loc.lng)) && (
                        <p className="font-data text-[10px] mt-1.5 pl-[46px]" style={{ color: "var(--color-text-tertiary)" }}>
