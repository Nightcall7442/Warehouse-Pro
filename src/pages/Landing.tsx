...
export default function Landing() {
  ...
  const faqItems = useMemo(() => [
    ...
    { q: "Какая поддержка предоставляется?", a: "Мы предоставляем email-поддержку для всех тарифов, приоритетную — для Basic и Pro. Для Pro также доступен персональный менеджер и помощь с настройкой интеграций." },
  ], []);
      ...
      <section id="pricing" className="py-28 relative z-10">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-5 max-w-5xl mx-auto">
            {[
              { name: "Trial", price: "0", period: "14 дней бесплатно", features: ["3 пользователя", "50 товаров", "Базовая аналитика", "Email-поддержка"], hl: false },
              { name: "Basic", price: "990", period: "сум/мес", features: ["10 пользователей", "500 товаров", "Полная аналитика", "GPS-трекинг", "Приоритетная поддержка"], hl: true },
              { name: "Pro", price: "2 490", period: "сум/мес", features: ["Без ограничений", "Интеграция с 1C", "API доступ", "White-label", "Персональный менеджер"], hl: false },
            ].map((plan, i) => (
