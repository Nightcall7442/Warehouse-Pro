    ...
    <div className="max-w-2xl mx-auto space-y-5 animate-fade-up">
      ...
      <div className="flex items-center gap-2 overflow-x-auto pb-1">
        {FILTERS.map((f) => (
          <button
            ...
            style={{
              background: filter === f.key ? "var(--color-primary-subtle)" : "var(--color-surface-light)",
              color: filter === f.key ? "var(--color-primary)" : "var(--color-text-secondary)",
              border: `1px solid ${filter === f.key ? "var(--color-primary-muted)" : "var(--color-border-subtle)"}`,
            }}
          >
      ...
      {!notifications || notifications.length === 0 ? (
        <div className="text-center py-20 panel">
          <div className="w-16 h-16 rounded-2xl mx-auto mb-4 flex items-center justify-center" style={{ background: "var(--color-surface-light)" }}>
        ...
        <div className="text-center py-16 panel">
          <Filter size={28} className="mx-auto mb-3 opacity-20" style={{ color: "var(--color-text-tertiary)" }} />
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-start justify-between gap-2">
                            <p className={`text-sm leading-snug ${!n.isRead ? "font-semibold" : ""}`} style={{ color: "var(--color-text-primary)" }}>
                              {n.title}
                            </p>
                          ...
                          <div className="flex items-center gap-2 mt-1.5">
                            ...
                            <span className="text-[10px] px-1.5 py-0.5 rounded font-medium" style={{ background: "var(--color-surface-light)", color: "var(--color-text-tertiary)" }}>
      ...
      {/* Stats footer */}
      {notifications && notifications.length > 0 && (
        <div className="text-center text-[11px] py-2" style={{ color: "var(--color-text-tertiary)" }}>
