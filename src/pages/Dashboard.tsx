    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
      ...
      <div className="stagger-children" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "12px" }}>
        ...
        {/* Плюс, а не «искры»: кнопка создаёт заказ, а не колдует. Sparkles —
            ...
            Ведёт на «Заказы» с открытым окном быстрого заказа, а не на
            /orders/new: тот адрес — мастер агента в три шага, свёрстанный под
            телефон (max-w-lg). Директор нажимал «Новый заказ» на большом
            экране и получал узкую мобильную форму посреди пустоты. */}
        <button onClick={() => navigate("/orders?new=1")} className="neo-btn-primary">
          <Plus size={16} />
