...
function CreatePlanForm({ date, onDone, lang }: { date: string; onDone: () => void; lang: "ru" | "uz" }) {
  ...
  return (
    <div className="panel p-5 space-y-4" style={{ borderColor: "color-mix(in srgb, var(--color-primary) 30%, transparent)" }}>
      ...
      <div className="flex items-center gap-3 flex-wrap">
        ...
        {total > 0 && (
          <div className="flex items-center gap-2 ml-auto">
            <span className="text-sm font-data" style={{ color: "var(--color-text-secondary)" }}>
              {visited}/{total}
            </span>
            <div className="w-28 h-2 rounded-full overflow-hidden" style={{ background: "var(--color-surface-light)" }}>
