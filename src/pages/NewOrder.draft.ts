...
export type OrderDraft = {
  ...
  promisedAt?: string;
  /* Заказ начат из корзины каталога. Без этого признака перезагрузка мастера
     (или выгруженная телефоном вкладка) поднимала черновик как обычный, и
     после отправки корзина не чистилась — агент оформлял заказ второй раз. */
  fromCart?: boolean;
};
