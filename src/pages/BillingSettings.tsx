...
const PLAN_FEATURES: Record<string, string[]> = {
  trial: ["3 пользователя", "50 SKU товаров", "100 заказов/мес", "Все функции"],
  basic: ["10 пользователей", "200 SKU товаров", "500 заказов/мес", "Приоритетная поддержка"],
  pro:   ["Безлимит пользователей", "Безлимит SKU", "Безлимит заказов", "SLA 99.9%", "Выделенный менеджер"],
};
