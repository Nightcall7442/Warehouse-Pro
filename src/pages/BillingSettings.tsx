...
const PLAN_FEATURES: Record<string, string[]> = {
  basic:     ["5 пользователей", "1 000 товаров", "Базовая аналитика", "Складской учёт", "Email-поддержка"],
  pro:       ["20 пользователей", "10 000 товаров", "Полная аналитика", "GPS-трекинг", "Интеграция с 1С", "Приоритетная поддержка"],
