      ...
      >
        <div style={{ display: "flex", alignItems: "flex-start", gap: "12px", marginBottom: "16px" }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <p style={{ fontSize: "13px", color: "#6b7280", margin: "4px 0 0", lineHeight: "1.5" }}>{message}</p>
          </div>
        ...
        <div style={{ display: "flex", gap: "8px", justifyContent: "flex-end" }}>
          <button onClick={onCancel} style={{ padding: "8px 16px", borderRadius: "8px", fontSize: "13px", fontWeight: 500, fontFamily: "'DM Sans', sans-serif", color: "#6b7280", background: "#f8f9fb", border: "none", cursor: "pointer" }}>Отмена</button>
