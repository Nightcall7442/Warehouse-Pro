...
export const LX = {
  ...
  goodDot: "#5f7d4e",
  badDot: "#b05a44",
  /* ── Регистры, добавленные при перекладке ──────────────────────────────────
     У страницы был один тон бумаги и одна тёмная зона того же цвета, что
     текст, — оттого ни глав, ни пауз. Три роли ниже дают лестницу
     ночь → чернила → бумага → оборот, не заводя ни одного нового цвета
     кроме ночи. Контрасты проверены: ink на verso 11.6:1, inkSoft 5.97:1;
     inkFaint и brassText на verso НИЖЕ AA — там только inkSoft и brassDeep. */
  verso: "#e6e2d8",        // оборот листа: третий регистр бумаги, полосы во всю ширину
  night: "#15130f",        // ночь: фон двух тёмных полос; чернила становятся панелью поверх неё
  brassDeep: "#7a5326",    // латунь текстом на verso и paperRaised — 5.29:1
  brassOnNight: "#c79351", // латунь на ночи — 6.7:1, единственный акцент тёмных полос

  /* ── Сцена и оправы (главы со снимками) ────────────────────────────────────
     Корпус телефона, стекло, свет и тени — тоже палитра, объявленная один раз.
     Число в самой главе храповик color-by-number считает «дёшево»; здесь —
     объявление, и оно исключено из счёта вместе с остальными токенами. */
  deviceBody:   "linear-gradient(155deg, #3d3934 0%, #1f1d1a 45%, #2c2925 100%)",
  deviceEdge:   "#121110",
  deviceButton: "#3a3733",
  deviceIsland: "#0b0a09",
  screenBlank:  "#f3f4f6",   // экран телефона до загрузки кадра
  appCanvas:    "#f4f5f7",   // холст приложения под веб-кадром
  white:        "#fff",
  whiteHalo:    "rgba(255,255,255,0.10)",
  glass:        "linear-gradient(112deg, rgba(255,255,255,0.14) 0%, rgba(255,255,255,0.03) 28%, transparent 44%)",
  /* Бумага на ночи, полупрозрачно: панели, разделители, дорожки. */
  paperOnInk03: "rgba(240,238,232,0.03)",
  paperOnInk04: "rgba(240,238,232,0.04)",
  paperOnInk06: "rgba(240,238,232,0.06)",
  paperOnInk10: "rgba(240,238,232,0.10)",
  paperOnInk34: "rgba(240,238,232,0.34)",
  /* Латунный свет — сцены и подсветка Pro. */
  brassGlow02:  "rgba(199,147,81,0.02)",
  brassGlow08:  "rgba(199,147,81,0.08)",
  brassGlow10:  "rgba(199,147,81,0.10)",
  brassGlow16:  "rgba(199,147,81,0.16)",
  brassGlow28:  "rgba(199,147,81,0.28)",
  /* Тени: тёплая под бумагу, ночная под чернила, чернильная плашка подсказок. */
  inkOverlay:   "rgba(38,35,30,0.92)",
  inkShade40:   "rgba(38,35,30,0.40)",
  inkShade45:   "rgba(38,35,30,0.45)",
  inkShade70:   "rgba(38,35,30,0.70)",
  brassShade25: "rgba(168,118,62,0.25)",
