...
describe("вкладка «Обзор»", () => {
  ...
  it("объём в «Топ товаров» — число, а не деньги", () => {
    // fmt приписывал валюту к количеству: «88 сум продано».
    поднять();
    expect(screen.getByText(/^40 продано$/)).toBeDefined();
    expect(screen.queryByText(/40 сум продано/)).toBeNull();
  });
