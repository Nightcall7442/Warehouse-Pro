...
describe("страница зарплат", () => {
  ...
  it("показывает фонд и его части", () => {
    ...
    /*
      Премии среди частей нет, и это проверяется прямо. Она платилась по двум
      процентам, зашитым в код, — их не назначал ни арендатор, ни платформа, —
      и убрана по решению владельца 11.09.2026.
    */
    expect(PAGE, "премия вернулась в состав начисления").not.toContain("ПРЕМИИ");
  });
